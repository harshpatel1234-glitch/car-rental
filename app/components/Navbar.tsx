  ...
  return (
    <div className='flex items-center justify-between p-3 px-5 shadow-md border-b-[1px]'>
      ...
      <div className='hidden md:flex gap-5'>
        ...
        <a href="#reviews-section" className=' hover:bg-blue-500 p-2 text-xl rounded-full hover:text-white px-3 cursor-pointer transition-all'>Reviews</a> {/* Added Reviews link */}
      </div>
      <UserButton />
    </div>
  )
